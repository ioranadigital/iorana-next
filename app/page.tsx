      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <div className="flex flex-col min-h-screen bg-[#0a2b49]">
            ...
            {/* 🛠️ AJUSTE PARA EL NAVBAR: 
                Lo envolvemos en un div con z-index superior para que el Hero no lo tape 
            */}
            <header className="relative z-[9999]">
              <Navbar />
            </header>
            
            {/* 🛠️ AJUSTE PARA EL CONTENIDO: 
                Aseguramos que el main no tenga overflow-hidden que corte el Nav 
            */}
