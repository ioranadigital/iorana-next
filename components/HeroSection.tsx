        ...
        >
          ...
          <div className="flex flex-wrap gap-12 mt-20 pt-10 border-t border-white/10">
            {[
              ...
              <div key={stat.label}>
                <div className="text-3xl md:text-4xl font-heading font-black text-[#ff8c00]">
                  {stat.value}
                </div>
                <div className="text-[10px] text-[#ebf2f7]/40 mt-1 uppercase tracking-widest font-bold font-sans">
                  {stat.label}
                </div>
              </div>
            ))}
